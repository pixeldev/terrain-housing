...
public class SchematicUtils {
    ...
    public static void paste(String id, String name) {
        ...
        Location origin = TerrainHousingPlugin.instance().getTerrainManager().getHousingByName(id).getOrigin();
        if (origin == null) return;

        File file = new File(TerrainHousingPlugin.instance().getDataFolder(), "schematics" + File.separator + name + ".schem");
        ...
        try {
            ...
            TerrainHousingPlugin.instance().getLogger().severe("Error loading schematic " + name + ".schem.");
        }
        ...
        try (EditSession editSession = WorldEdit.getInstance()
            ...
            TerrainHousingPlugin.instance().getLogger().severe("Error pasting schematic " + name + ".schem.");
        }
    }
    ...
    public static void save(String id, String name) {
        Housing housing = TerrainHousingPlugin.instance().getTerrainManager().getHousingByName(id);
        ...
        File file = new File(TerrainHousingPlugin.instance().getDataFolder(), "schematics" + File.separator + name + ".schem");
        File dir = new File(TerrainHousingPlugin.instance().getDataFolder(), "schematics");
        if (!dir.isDirectory())
            dir.mkdirs();
        ...
        try (ClipboardWriter writer = BuiltInClipboardFormat.SPONGE_SCHEMATIC.getWriter(new FileOutputStream(file))) {
            ...
            TerrainHousingPlugin.instance().getLogger().severe(name + "Error saving schematic " + name + ".schem in disk.");
        }
    }
